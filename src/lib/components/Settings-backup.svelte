    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3">
            <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="timezone" class="block text-sm font-medium text-black/70 mb-2">Timezone</label>
                                    <select 
                                        id="timezone"
                                        bind:value={settings.general.timezone}
                                        class="w-full px-4 py-3 border border-black/20 bg-white focus:border-black/40 focus:outline-none transition-colors cursor-pointer"
                                    >
                                ...
                                <div>
                                    <label for="language" class="block text-sm font-medium text-black/70 mb-2">Language</label>
                                    <select 
                                        id="language"
                ...
                {#if activeTab === 'notifications'}
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center justify-between py-4 border-b border-black/5">
                                <div>
                                    <p class="text-sm font-medium text-black/80">Push Notifications</p>
                                    <p class="text-xs text-black/50">Browser push notifications</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" bind:checked={settings.notifications.pushNotifications} class="sr-only peer">
                                    <div class="w-11 h-6 bg-black/10 peer-focus:outline-none border border-black/20 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-black/20 after:border after:h-4 after:w-4 after:transition-all peer-checked:bg-black peer-checked:border-black"></div>
                                </label>
                            </div>
                            <div class="flex items-center justify-between py-4 border-b border-black/5">
                                <div>
                                    <p class="text-sm font-medium text-black/80">Weekly Reports</p>
                                    <p class="text-xs text-black/50">Receive weekly activity summary</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" bind:checked={settings.notifications.weeklyReports} class="sr-only peer">
                                    <div class="w-11 h-6 bg-black/10 peer-focus:outline-none border border-black/20 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-black/20 after:border after:h-4 after:w-4 after:transition-all peer-checked:bg-black peer-checked:border-black"></div>
                                </label>
                            </div>
                            <div class="flex items-center justify-between py-4">
                                <div>
                                    <p class="text-sm font-medium text-black/80">System Alerts</p>
                                    <p class="text-xs text-black/50">Important system notifications</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" bind:checked={settings.notifications.systemAlerts} class="sr-only peer">
                                    <div class="w-11 h-6 bg-black/10 peer-focus:outline-none border border-black/20 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-black/20 after:border after:h-4 after:w-4 after:transition-all peer-checked:bg-black peer-checked:border-black"></div>
                                </label>
                            </div>
                        </div>
                ...
                {#if activeTab === 'security'}
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="sessionTimeout" class="block text-sm font-medium text-black/70 mb-2">Session Timeout (minutes)</label>
                                    <input 
                                        id="sessionTimeout"
                                        type="number" 
                                ...
                                <div>
                                    <label for="passwordExpiry" class="block text-sm font-medium text-black/70 mb-2">Password Expiry (days)</label>
                                    <input 
                                        id="passwordExpiry"
                                        type="number" 
                ...
                {#if activeTab === 'advanced'}
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center justify-between py-4 border-b border-black/5">
                                <div>
                                    <p class="text-sm font-medium text-black/80">Analytics</p>
                                    <p class="text-xs text-black/50">Track user behavior and performance</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" bind:checked={settings.advanced.analyticsEnabled} class="sr-only peer">
                                    <div class="w-11 h-6 bg-black/10 peer-focus:outline-none border border-black/20 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-black/20 after:border after:h-4 after:w-4 after:transition-all peer-checked:bg-black peer-checked:border-black"></div>
                                </label>
                            </div>
                            <div class="flex items-center justify-between py-4 border-b border-black/5">
                                <div>
                                    <p class="text-sm font-medium text-black/80">Caching</p>
                                    <p class="text-xs text-black/50">Improve application performance</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" bind:checked={settings.advanced.cacheEnabled} class="sr-only peer">
                                    <div class="w-11 h-6 bg-black/10 peer-focus:outline-none border border-black/20 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-black/20 after:border after:h-4 after:w-4 after:transition-all peer-checked:bg-black peer-checked:border-black"></div>
                                </label>
                            </div>
                            <div class="flex items-center justify-between py-4">
                                <div>
                                    <p class="text-sm font-medium text-black/80">Compression</p>
                                    <p class="text-xs text-black/50">Reduce bandwidth usage</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" bind:checked={settings.advanced.compressionEnabled} class="sr-only peer">
                                    <div class="w-11 h-6 bg-black/10 peer-focus:outline-none border border-black/20 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-black/20 after:border after:h-4 after:w-4 after:transition-all peer-checked:bg-black peer-checked:border-black"></div>
                                </label>
                            </div>
                        </div>
                ...
                {#if activeTab === 'notifications'}
                    <div>
                        <h3 class="text-lg font-light text-black/80 mb-4">Notification Settings</h3>
                        <div class="space-y-4">
                ...
                {#if activeTab === 'security'}
                    <div>
                        <h3 class="text-lg font-light text-black/80 mb-4">Security Settings</h3>
                        <div class="space-y-6">
                            <div class="flex items-center justify-between py-2 border-b border-black/5">
                                <div>
                                    <p class="text-sm font-medium text-black/80">Two-Factor Authentication</p>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-black/70 mb-2">Session Timeout (minutes)</label>
                                <input 
                                    type="number" 
                                    bind:value={settings.security.sessionTimeout}
                                    class="w-full px-4 py-2 border border-black/20 focus:border-black/40 focus:outline-none transition-colors"
                                    min="5"
                                    max="1440"
                                />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-black/70 mb-2">Password Expiry (days)</label>
                                <input 
                                    type="number" 
                                    bind:value={settings.security.passwordExpiry}
                                    class="w-full px-4 py-2 border border-black/20 focus:border-black/40 focus:outline-none transition-colors"
                ...
                {#if activeTab === 'advanced'}
                    <div>
                        <h3 class="text-lg font-light text-black/80 mb-4">Advanced Settings</h3>
                        <div class="space-y-4">
                            <div class="flex items-center justify-between py-2 border-b border-black/5">
                                <div>
                                    <p class="text-sm font-medium text-black/80">Debug Mode</p>
                ...
                <div class="mt-8 pt-6 border-t border-black/10">
                    <div class="flex justify-end gap-4">
                        <button class="px-6 py-2 border border-black/20 text-black/70 hover:border-black/40 hover:text-black transition-colors">
                            Reset
                        </button>
                        <button 
                            on:click={saveSettings}
                            class="px-6 py-2 bg-black text-white hover:bg-black/80 transition-colors"
                        >
                            Save Changes
                        </button>
                    </div>
